...
<script src="${pageContext.request.contextPath}/fckeditor/fckeditor.js"
...
<body>
	...
	<div id="MainArea">
		...
		<s:form action="topic_save" cssStyle="margin: 0; padding: 0;">
			<s:hidden name="id" value="%{#topic.id}"></s:hidden>
			...
			<center>
				<div class="ItemBlock_Title1">
					<div width=85% style="float: left">
						...
						<font class="MenuPoint"> &gt;&gt; </font> 修改主题
					</div>
				</div>
					...
					<table border="0" cellspacing="1" cellpadding="1" width="100%"
						...
						<tr>
							...
							<td class="InputAreaBg"><div class="InputContent">
									<s:textfield name="title" value="%{#topic.title}"
										cssClass="InputStyle" cssStyle="width:100%" />
								</div></td>
						</tr>
						<tr height="240">
							...
							<td class="InputAreaBg">
								<div class="InputContent">
									<s:textarea name="content" value="%{#topic.content}"
