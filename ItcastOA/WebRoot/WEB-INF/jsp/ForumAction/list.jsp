					...
					<tbody class="dataContainer" datakey="forumList">
						...
						<s:iterator value="#forumList">
							<tr height="78" align="center" class="template">
								...
								<td width="200" class="ForumPageTableDataLine">
									<ul class="ForumPageTopicUl">
										<li class="ForumPageTopic"><s:a cssClass="ForumPageTopic"
												action="forum_show?id=%{id}">${name}</s:a></li>
								...
								<td class="ForumPageTableDataLine">
									<ul class="ForumPageTopicUl">
										<li><font color="#444444">┌ 主题：</font> <s:a
												cssClass="ForumTitle" action="topic_show?id=%{lastTopic.id}">${lastTopic.title}</s:a>
										</li>
