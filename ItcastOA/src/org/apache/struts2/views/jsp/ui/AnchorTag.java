...
public class AnchorTag extends AbstractClosingTag {
	...
	public int doEndTag() throws JspException {
		...
		// 当前准备访问的URL地址
		String priviUrl = "/" + action;

		if (user.hasPrivilegeByUrl(priviUrl)) {
			return super.doEndTag();// 正常的生成并显示超链接
		} else {

			return EVAL_PAGE;// 不生成超链接， 继续执行頁面中的代码
			// SKIP_PAGE;//跳过剩余的标签
